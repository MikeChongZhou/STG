...
echo "│     Product Name: ScreenTimeExtention                     │"
echo "│     Team: Your developer team                             │"
echo "│     Project: Runner                                       │"
echo "│                                                           │"
echo "│  2. For BOTH Runner and ScreenTimeExtention targets:      │"
echo "│     → Signing & Capabilities → + App Groups               │"
echo "│     → Add: group.com.timbertrail.screenguardian           │"
echo "│     → + Capability → Family Controls                      │"
echo "│                                                           │"
echo "│  3. Replace ScreenTimeExtention/DeviceActivityMonitor..   │"
echo "│     .swift with the one from ios/ScreenTimeExtention/     │"
echo "│                                                           │"
